...
class Tournament(Model):
    ...
    name = fields.CharField(
        max_length=255, description="Tournament name", index=True)
    created = fields.DatetimeField(
        auto_now_add=True, description="Created datetime")
...
class Event(Model):
    ...
    token = fields.CharField(
        max_length=100, description="Unique token", unique=True)
